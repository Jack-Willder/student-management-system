...
export default function EditStudentForm({ setEditVisible, form, setForm, currentStudentId, refresh, reload }) {
  ...
  async function handleSubmit(e) {
    ...
    setMessage('');
      ...
      try {
          const res = await fetch(`/api/update/${currentStudentId}`, {
              method: "PUT",
    ...
    <label className="flex items-center gap-2 cursor-pointer">
      ...
      <span className="px-3 py-1 rounded-full bg-red-100 text-red-700 text-sm">
        ...
        <div className="md:col-span-2">
          ...
          >
            {status === 'loading' ? 'Adding...' : 'Save Changes'}
          </button>
        </div>
